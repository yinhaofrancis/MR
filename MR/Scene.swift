...
//            encoder?.setVertexBytes(scene, length: MemoryLayout<T>.size, index: Int(scene_object_buffer_index))
//            encoder?.setFragmentBytes(scene, length: MemoryLayout<T>.size, index: Int(scene_object_buffer_index))
//        }
//        
//        deinit{
//            scene.deallocate()
...
//}
//
//extension MR.DisplayScene where T == SceneObject{
